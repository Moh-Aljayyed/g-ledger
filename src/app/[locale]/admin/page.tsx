    ...
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-3 flex-wrap">
          <Link
            href="/ar/admin/todo"
            className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl text-sm font-bold hover:shadow-lg transition-all flex items-center gap-2"
          >
            📋 مركز المهام (TODO)
            <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-white/20">4</span>
          </Link>
          <Link
