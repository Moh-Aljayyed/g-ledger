  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#021544]">📋 مركز المهام (TODO Center)</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
        {[
          ...
          <a
            key={r.title}
            href={r.anchor}
            className={`block p-4 rounded-xl border bg-gradient-to-br ${r.color} hover:shadow-md transition-shadow cursor-pointer`}
          >
      ...
      {/* ============ Scaling & Performance ============ */}
      <div id="scaling" className="mb-8 bg-card rounded-xl border border-red-200 p-6 scroll-mt-6">
      ...
      {/* ============ Raqyy ============ */}
      <div id="raqyy" className="mb-8 bg-card rounded-xl border border-border p-6 scroll-mt-6">
        <div className="flex items-center justify-between mb-4">
          <div>
      ...
      <div id="restaurant" className="mb-8 bg-card rounded-xl border border-border p-6 scroll-mt-6">
      ...
      <div id="medical" className="mb-8 bg-card rounded-xl border border-border p-6 scroll-mt-6">
        <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
          <div>
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={wave.num}
              className="flex items-start gap-3 p-4 rounded-lg bg-gradient-to-r from-purple-50/50 to-pink-50/30 border border-purple-100"
            >
